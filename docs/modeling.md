...
2. **Persistencia**: el servicio llama al `EventNodeRepository`, que inserta/actualiza una única fila en `event_nodes` con la colección `requested_targets` serializada como `jsonb`.
